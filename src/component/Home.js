                ...
                <div className="row">
                  <div className=" col-sm-8 col-12 ">
                    <ul className='liststyle'>
                      <li><span className="material-symbols-outlined">check_small</span>We offer free initial consultations</li>
                      <li><span className="material-symbols-outlined">check_small</span>Very reasonable rates</li>
                      <li><span className="material-symbols-outlined">check_small</span>We provide an accurate fee quote upfront and provide it in writing without any chance of any hidden costs</li>
                      <li><span className="material-symbols-outlined">check_small</span>We also offer flexible interest-free payment plans.</li>
                    </ul>
                  </div>
                </div>
              </div>
